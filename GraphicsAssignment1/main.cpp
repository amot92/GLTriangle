...
void init( void )
{
    ...
    GLuint buffer;
    glGenBuffers( 1, &buffer );//get name of buffer
    glBindBuffer( GL_ARRAY_BUFFER, buffer );//make that buffer 'current'
    glBufferData( GL_ARRAY_BUFFER, sizeof(points), points, GL_STATIC_DRAW );//copy data from app to GPU -- of type buffer -- sizeof(points) -- and the data
    ...
    //5. create, source, and compile shader objects
    ...
    //6. create shader program & attach shaders
